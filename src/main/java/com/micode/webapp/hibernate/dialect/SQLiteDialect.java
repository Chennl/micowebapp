package com.micode.webapp.hibernate.dialect;
...
public class SQLiteDialect extends Dialect {
	...
	private static final SQLServerIdentityColumnSupport IDENTITY_COLUMN_SUPPORT = new SQLServerIdentityColumnSupport();
	@Override
